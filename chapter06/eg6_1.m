...
% * *Output* : |eg6_1_A.png, eg6_1_B.png, eg6_1_C.png|
% * *Usage* : |eg6_1(), eg6_1(10, 1000)|
%
%% Source Code
function eg6_1(n, N)
    % init
    ...
    plotFigure(2, 2, id, num2str(o), X, P * t, x, y);
    saveas(gcf, 'eg6_1_A', 'png');
    figure('Name', 'example 6-1 B'); clf; hold on;
    axis([-4 4 -4.5 3.5]);
    plot(X, P * t, 'g-', x, y, 'bo');
    setFigure(gca, 'example 6-1 final result');

    % save figure
    saveas(gcf, 'eg6_1_B', 'png');
    ...
    setFigure(gca, 'example 6-1 Compare Least Huber with Least L1');

    % save figure
    saveas(gcf, 'eg6_1_C', 'png');
end