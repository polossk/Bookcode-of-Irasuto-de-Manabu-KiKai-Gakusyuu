%% Example 6.2 Least Tukey Loss Regression & Least L1 Regression
%
% * *Result in book* : Figure 6.8(e = 1), Figure 6.3(e = 0.01)
% * *Code in book* : Figure 6.9
% * *Output* : |eg06_2_A.png, eg06_2_B.png, eg06_2_C.png|
% * *Usage* : |eg06_2(), eg06_2(10, 1000)|
%
%% Source Code
function eg06_2(n, N)
    % init
